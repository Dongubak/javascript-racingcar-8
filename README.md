...
> 
### TC-11: 3명 · 3회 시도 · 공동 우승(2명)

> **이름**
> `tie winners — pobi,woni,jun / 3 — [3,4,4, 4,3,4, 3,4,3] — woni,jun win`
>
> **입력**
>
> | 단계    | 값               |
...
> **모의 랜덤(mockRandoms 전달 배열)**
> `[3,4,4, 4,3,4, 3,4,3]`
> 1턴: pobi(3), woni(4), jun(4)
> 2턴: pobi(4), woni(3), jun(4)
> 3턴: pobi(3), woni(4), jun(3)
>
> **기대 로그**
>
> ```bash
...
### TC-12: 1명 · 4회 시도 · 단독 우승 & 스냅샷 수 검증

> **이름**
> `single player — solo / 4 — [4,3,4,4] — solo wins`
>
> **입력**
>
> | 단계    | 값      |
...
> **기대 로그(요지)**
>
> * 스냅샷 라인에 `solo :`가 **총 4회** 출력
> * 최종: `최종 우승자 : solo`

### TC-13: 경계값 검증(정지/전진 분기) — 3이면 정지, 4면 전진
...
### TC-14: “실행 결과” 머리글 포함 여부

> **이름**
> `format header — pobi,woni / 1 — [4,4]`
>
> **입력**
>
> | 단계    | 값           |
...
### ~~TC-15: 랜덤 호출 횟수 = (참가자 수 × 시도 횟수)~~

> **이름**
> `random calls — a,b,c / 5 — 15 calls`
>
> **입력**
>
> | 단계    | 값       |
...
> **기대 결과**
>
> * `MissionUtils.Random.pickNumberInRange` 호출 횟수 = 15

### ~~TC-16: 입력 횟수 검증(질문은 정확히 2회)~~

> **이름**
> `questions count — pobi,woni / 2`
>
> **입력**
>
> | 단계    | 값           |
...
> **기대 결과**
>
> * `MissionUtils.Console.readLineAsync` 호출 횟수 = 2

### TC-17: 전체 동률(모두 매 턴 전진) → 모두 공동 우승

> **이름**
> `all tie — a,b,c / 2 — [4,4,4, 4,4,4]`
>
> **입력**
>
> | 단계    | 값       |
...
### TC-18: 중간 라운드 전원 정지 후 마지막 라운드만 이동

> **이름**
> `mid all stop — a,b / 3 — [4,4, 3,3, 4,3] — a wins`
>
> **입력**
>
> | 단계    | 값     |
...
### TC-19: 이름 입력 — 공백만 입력(트리밍 후 빈 문자열)

> **이름**
> `Invalid names - whitespace only`
>
> **입력**
>
> | 단계 | 값     |
...
> **기대 결과**
>
> * `[ERROR] : Input is empty` 포함하여 reject

### TC-20: 이름 입력 — 콤마 끝에 빈 요소 포함

> **이름**
> `Invalid names - trailing comma`
>
> **입력**
>
> | 단계 | 값       |
...
> **기대 결과**
>
> * `[ERROR] : Empty name detected` 포함하여 reject

### TC-21: 시도 횟수 — 공백/개행 포함(숫자 아님)

> **이름**
> `Invalid trials - whitespace/newline`
>
> **입력**
>
> | 단계    | 값           |
...
> **기대 결과**
>
> * `[ERROR] : input is none a number` 포함하여 reject

### TC-22: 시도 횟수 — 실수 입력(정수 아님)

> **이름**
> `Invalid trials - float`
>
> **입력**
>
> | 단계    | 값           |
...
> **기대 결과**
>
> * `[ERROR] : input is none a number` **또는** 정수 아님을 나타내는 메시지 포함하여 reject
